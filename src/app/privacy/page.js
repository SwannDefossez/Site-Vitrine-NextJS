  ...
  return (
    <main className={css.main}>
      <div className={css.content}>
        <h1>Ces clauses sont là à titre d'exemple , n'oubliez pas des les remplacer par les votres</h1>
        <div className={css.content__info}>
          ...
          <p>
            ...
            that is collected and recorded by My Website and how we use it.
          </p>
          <p>
            <br />
          </p>
          ...
          <p>
            ...
            respective advertisements and links that appear on&My Website, which
